                ...
                String androidId = request.getParameter("androidId");
                 ...
                 try {
                  ...
                  insertUsers = connection.prepareStatement(
                            "INSERT INTO devices ( projectprojectID, useruserID , BuildFingerPrint, BuildID, KernelVersion, BuildBrand, BuildManuf,"
                          + " BuildModel, BuildRelease, BuildSDK, BuildABIList, imeistring, imsistring, serialnum, serialnum2, androidId)"
                  + " VALUES ('" +projectprojectID+ "' , '" +useruserID+"' , '"  + BuildFingerPrint + "' , '" + BuildID + "' + '" +KernelVersion+ "' , '" +BuildBrand +"' , '"  + BuildManuf + "' , '" + BuildModel + "'" 
                  + " '" +BuildRelease+ "' ,'" +BuildSDK+ "' ,'" +BuildABIList+ "' ,'" +imeistring+ "' ,'" +imsistring+ "' ,'" +serialnum+ "' ,'" +serialnum2+ "' ,'" +androidId+ "' )"); 
